...
export function IconHome(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconMoveHorizontal(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconMousePointer(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconHand(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconType(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconHighlighter(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconUnderline(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconStrikethrough(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconStickyNote(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconSignature(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
      <path d="m21 17-2.156 1.868A4.004 4.004 0 0 1 16 20h-1" />
      <path d="M3 12c2 0 3.5-2 5-2s3 2 5 2 3.5-2 5-2 3 2 5 2" />
      <path d="M12 21h9" />
    </BaseIcon>
  );
}
...
export function IconInfo(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconBadgeCheck(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconCrown(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconFilePlus(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
      <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" />
      <path d="M14 2v4a2 2 0 0 0 2 2h4" />
...
export function IconMessageSquare(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconMic(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
...
export function IconStamp(props: IconProps): React.ReactElement {
  return (
    <BaseIcon {...props}>
      <path d="M5 22h14" />
